...
class IEC62056Component : public Component, public uart::UARTDevice {
 public:
  ...
  /// Set flag indicating to allow for commas in the values.
  /// @param flag @c true to allow for commas, else @c false.
  void set_allow_comma(bool flag) { allow_comma_ = flag; }
 ...
 protected:
  ...
  bool battery_meter_;
  /// @brief Flag to allow for commas in values.
  bool allow_comma_;
